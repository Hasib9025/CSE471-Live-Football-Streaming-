...
<body>
    ...
    <center>
        ...
        <video width="720" height="480" controls>
            <source
                src="{{ asset('videos/Chelsea 4-4 Man City _ HIGHLIGHTS _ Premier League 2023_24.mp4') }}"
                type="video/mp4">
        ...
        <video width="720" height="480" controls>
            <source
                src="{{ asset('videos/Portugal v Spain _ 2018 FIFA World Cup _ Match Highlights.mp4') }}"
                type="video/mp4">
            Your browser does not support the video tag.
        </video>
        ...
        <video width="720" height="480" controls>
            <source
                src="{{ asset('videos/Man City 1-1 Liverpool _ HIGHLIGHTS Haaland & Trent Alexander-Arnold Goals.mp4') }}"
                type="video/mp4">
            Your browser does not support the video tag.
        </video>
        ...
        <video width="720" height="480" controls>
            <source
                src="{{ asset('videos/Newcastle 4-1 Chelsea _ HIGHLIGHTS _ Premier League 2023_24.mp4') }}"
                type="video/mp4">
            Your browser does not support the video tag.
        </video>
