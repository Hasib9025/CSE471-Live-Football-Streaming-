                    ...
                    <table>
                        <tbody>
                            <tr>
                                <td>Name</td>
                                <td>:</td>
                                <td><input type="text" name="name" value="<?php echo e($da1->name); ?>"></td>
                            ...
                            <tr>
                                <td>Number</td>
                                <td>:</td>
                                <td><input type="text" name="number" value="<?php echo e($da1->number); ?>"></td>
...
</html><?php /**PATH C:\Users\hhasi\Downloads\football (3)\football\resources\views/editprofileinfo.blade.php ENDPATH**/ ?>